    ...
    <div className="bg-gray-50">
      ...
      <section className="py-14 md:py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          {/* SEARCH BAR */}
          <div className="bg-white rounded-2xl md:rounded-full shadow-md flex flex-col md:flex-row items-center gap-3 p-4 max-w-4xl mx-auto">

            <input
              className="w-full md:flex-1 px-4 py-2 outline-none text-sm"
              placeholder="Skills, job title or company"
              value={query}
              onChange={(e) => setQuery(e.target.value)}
            />
            ...
            <input
              className="w-full md:flex-1 px-4 py-2 outline-none text-sm border-t md:border-t-0 md:border-l"
              placeholder="Location"
              value={location}
              onChange={(e) => setLocation(e.target.value)}
            />
            ...
            <button
              onClick={handleSearch}
              className="text-white px-6 py-2 rounded-full w-full md:w-auto"
              style={{ background: "linear-gradient(90deg,#ff0066,#8000ff)" }}
            >
              Search
            </button>
      ...
      <section className="py-10 md:py-16 text-center">
        ...
        <h2 className="text-2xl md:text-4xl font-bold text-pink-700 mb-10">
          Current Opportunities
        </h2>
      ...
      <section className="py-10 bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <h2 className="text-2xl md:text-4xl font-bold text-center text-pink-700 mb-12">
            Your Questions, Answered
          </h2>
      ...
      {/* CTA */}
      <section
        className="pt-14 md:pt-20 pb-12 md:pb-16 text-white text-center"
        style={{ background: "linear-gradient(90deg,#ff0066,#8000ff)" }}
      >
